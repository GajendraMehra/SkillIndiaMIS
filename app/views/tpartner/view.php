...
$this->title = $model->tp_name;
if (Yii::$app->user->identity->role==1) {
    # code...
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Training Partner'), 'url' => ['index']];
}
elseif (Yii::$app->user->identity->role==4) {
    # code...
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'All Tranche'), 'url' => ['trans/index']];
}
else{
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Approval Status'), 'url' => ['create']];
        ...
        <div class="col-10">
            ...
            <div class="accordion" id="accordionExample2">
                <div class="card">
                    <div class="card-header" id="headingOne">
                        <h5 class="mb-0">
                    <button class="btn btn-link btn-block text-left text-uppercase" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fa fa-eye main"></i><i class="fa fa-angle-double-right mr-3"></i>Invoice and Payment Details
                    </button>
                    </h5>
                    </div>

                    <div id="collapseTwo" class="collapse show fade" aria-labelledby="headingOne" data-parent="#accordionExample2">
                        <div class="card-body">
                        <?= DetailView::widget([
                        'model' => $modelTpartnerInvoice,
                        'hAlign'=>'left',

                        'attributes' =>  [

                            [
                                'attribute'=> 'orgtype_id',
                                'format'=>'html',
                                'value'=>OrganisationType::findOne($modelTpartnerInvoice->orgtype_id)->type_name
                            ...
                            [
                                'attribute'=> 'tan',
                                'format'=>'html',
                                'value'=>(!$modelTpartnerInvoice->tan)? " (Not set ) ": $modelTpartnerInvoice->tan

                            ],
                            [
                                'attribute'=>'status',
                                'format'=>'html',
                                'value'=>CommonModel::labelsStatus($modelTpartnerInvoice->status)
                            ],
                            'smart_id',
                            'reg_date',
                                ],
            ...
            <div class="accordion" id="accordionExample2">
             ...
             <div class="accordion" id="accordionExample2">
                <div class="card">
                    <div class="card-header" id="headingOne">
                        <h5 class="mb-0">
                    <button class="btn btn-link btn-block text-left text-uppercase" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
                        <i class="fa fa-eye main"></i><i class="fa fa-angle-double-right mr-3"></i>SINGLE POINT OF CONTACT-OPERATION (SPOC-FINANCE)
                    </button>
                    </h5>
                    </div>

                    <div id="collapseSix" class="collapse show fade" aria-labelledby="headingOne" data-parent="#accordionExample2">
                        <div class="card-body">
                        <?= DetailView::widget([
                        'model' => $modelTpdetailSpocfinance,
                        'hAlign'=>'left',
                        ...
                        'attributes' =>[
                            ...
                            [
                                'attribute'=>'gender',
                                'format'=>'html',
                                'value'=>CommonModel::labelsGender($modelTpdetailSpocfinance->gender)
                            ],
                            'designation',
                            [
                              'attribute'=>  'aadhar_no',
