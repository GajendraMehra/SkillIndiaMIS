            ...
            return '<span class="badge badge-danger">Passed</span>';
              ...
              [
                  ...
                  'buttons' => [
                    'delete' => function($url, $model){
                        return Html::a('Delete', ['delete', 'id' => $model->id], [
                            ...
                            'data' => [
                                'confirm' => 'Are you absolutely sure ? You will lose all the related  information about this Batch  with this action.',
                                'method' => 'post',
                                'class' => 'danger'
                            ],
                        ]);
                  ...
                  'urlCreator' => function($action, $model, $key, $index) {
                          ...
                          return Url::to(['batch-attendance','id'=>$key]);
                  },
                  'viewOptions'=>['role'=>'modal-local' ,
                  'icon'=>'glyphicon glyphicon-trash',
                  'label' => 'View Report','class' => 'btn btn-success btn-sm'],
