...
<?= $this->render('/layouts/flashes'); ?>
  ...
  <div class="login">
    <h2 class="login-title"><img src="custom/images/logo.png" alt="" srcset=""></h2>
    <form class="form-login" autocomplete="off" action="/backend/web/index.php?r=site%2Flogin" method="POST">
      <label for="text">Username</label>
      <div class="input-text">
        <i class="fas fa-envelope icon"></i>
        <input type="text" name="LoginForm[username]" value="admin" placeholder="Enter your Username"  autocomplete="off">
      </div>
  ...
  <div class="background">
    <h1>Skill India -
    Kaushal Bharat Kushal Bharat</h1>
