...
// print_r($data);
// echo $dis;
$allTrancheCount= $allTranche->count();
        ...
        <div class="row">
            ...
            <div class="card-body">
               ...
               echo' <i class="fa fa-bell bg-warning bg-warning p-3 font-2xl mr-3 float-left text-light"></i>';
                    ...
                    ?>
                    <div class="h5 text-secondary mb-0 mt-1"><?= $allTrancheCount ?>  Tranche </div>
                    <div class="text-muted text-uppercase font-weight-bold font-xs small">Generated </div>
                </div>
