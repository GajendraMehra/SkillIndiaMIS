...
if(\yii::$app->user->identity->role=="5"){
  ...
  foreach ($restrictKey as $key => $value) {
    if (strpos($url, $value) !== false) {
        Yii::$app->getResponse()->redirect(['batch/remote-send','id'=>2]);
    //    die;
    }
  }
...
<ul class="nav navbar-nav">
    ...
    <li class="menu-item-has-children dropdown  <?= $className; ?>">
        ...
        <!-- <li><i class="fa fa-window-close" aria-hidden="true"></i><a href="<?=  Yii::$app->homeUrl ?>?r=student/create">Add New </a></li> -->
