...
/**
 * This is the model class for table "tbl_tpdetail_spocfinance".
 *
 * @property int $id
 ...
 * @property int $tp_id
 */
class TpdetailSpocfinance extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_tpdetail_spocfinance';
    }
    ...
    {
        return [
            [['name', 'gender', 'designation', 'aadhar_no', 'mobile_no', 'email', 'created_at', 'updated_at', 'edited_by', 'tp_id'], 'required'],
            [['name', 'designation', 'aadhar_no', 'email'], 'string'],
            [['gender', 'edited_by', 'tp_id'], 'integer'],
            [['created_at', 'updated_at'], 'safe'],
            [['mobile_no', 'landline_no'], 'string', 'max' => 45],
            [['mobile_no'], 'string', 'min' => 10,'max'=>11],
            array(['name', 'designation'],'match', 'pattern'=>"/^([A-Za-z0-9 _-]*)$/", ),

            // [['mobile_no'],'match', 'pattern' => "/[2-9]{2}\d{8}$/"],
            // [['mobile_no'],'match', 'pattern' => "^(?:00|\+)[0-9]{4}-?[0-9]{7}$"],
