...
/**
 * This is the model class for table "tbl_tcenter_bank".
 *
 * @property int $id
 ...
 * @property int $tc_id
 */
class TcenterBank extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
